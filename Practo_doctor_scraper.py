...
s = ['', 'Cardiologist', 'Dentist', 'Dermatologist', 'Gynecologist', 'Pediatrician', 'Radiologist', 'Urologist', 'Psychiatrist', 'General Physician', 'Ayurveda', 'Ear-nose-throat (ENT) Specialist', 'Neurologist', 'Homeopath']
